    ...
    <form action="update" method="post">
        <div class="form-group">
            <div class="input-group">
                ...
                <input class="form-control" type="text" name="id" readonly="" value="<?php echo $project->getId() ?>">
            </div>
        </div>
        <div class="form-group <?php echo $projectValidator->isNameError() ? "has-error" : ""; ?>">
            <div class="input-group">
                ...
                <input class="form-control" type="text" name="name" value="<?php echo TemplateView::noHTML($project->getName()) ?>">
            </div>
        ...
        <div class="form-group <?php echo $projectValidator->isDescriptionError() ? "has-error" : ""; ?>">
            <div class="input-group">
                ...
                <input class="form-control" type="text" name="email" value="<?php echo TemplateView::noHTML($project->getDesc()) ?>">
            </div>
        ...
        <div class="form-group <?php echo $projectValidator->isStartDateError() ? "has-error" : ""; ?>">
            <div class="input-group">
                ...
                <input class="form-control" type="date" name="mobile" value="<?php echo TemplateView::noHTML($project->getStartDate()) ?>">
            </div>
        ...
        <div class="form-group <?php echo $projectValidator->isEndDateError() ? "has-error" : ""; ?>">
            <div class="input-group">
                ...
                <input class="form-control" type="date" name="mobile" value="<?php echo TemplateView::noHTML($project->getEndDate()) ?>">
            </div>
